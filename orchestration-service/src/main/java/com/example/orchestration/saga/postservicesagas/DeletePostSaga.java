...
public class DeletePostSaga {
  ...
  public void initSaga(String token, PostDto postDto) throws Exception {
    ...
    this.step = new Step.StepBuilder()
        ...
        .addStep(
            commandMessage -> postServiceProxy.deletePost(commandMessage),
            postDto
        ).build();
  }
