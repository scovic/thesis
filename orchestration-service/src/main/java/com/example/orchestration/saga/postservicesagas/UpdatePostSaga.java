...
import com.example.orchestration.dto.postservice.UpdatePostDto;
...
public class UpdatePostSaga {
  ...
  public void initSaga(String token, UpdatePostDto updatePostDto) throws Exception {
    ...
    this.step = new Step.StepBuilder()
        ...
        .addStep(
            commandMessage -> this.postServiceProxy.updatePost(commandMessage),
            updatePostDto
        )
        .build();
  }
